...
1. Open terminal and cd to 'jb-tgchallenge'
2. To run the server: 'npm run serve'
3. Open a new terminal and cd to 'jb-tgchalleng'
4. Then to run the application: 'npm start' --> it will ask to use different port, click 'y' for yes

You can also run unit tests on the application:
1. Open new termincal and cd to 'jb-tgchallenge' 
